            ...
            <div class="widget-content">
                ...
                <?php
                  if ( $current_user['AccountType']['name'] != 'Staff' ) {
                    echo $this->Html->link('<i class="icon icon-plus"></i> Add', 
              ...
              <table class="table table-striped table-bordered">
                <thead>
                  <tr>
                    ...
                    <th class="td-actions" width="14%"> </th>
                    <?php endif ?>
                  </tr>
                </thead>
                <tbody>
                    <?php 
                        ...
                        foreach ($accounts as $account): ?>
                            ...
                            <!-- Filter according to branch id and account type* -->
                            <?php if ($current_user['Branch']['id'] == $account['Branch']['id'] or $current_user['AccountType']['name'] == 'Super Admin'): ?>
                  <tr>
                    <td> <?php echo ++$i; ?> </td>
                    <td> <?php echo $account['MedicalFacility']['name'];?> </td>
                    <td> <?php echo $account['Branch']['tagname']; ?>
                    ...
                    <td class="td-actions">
                        ...
                        <!-- Root user -->
                        <?php if ($current_user['root_user'] == 1): ?>
                        ...
                        <!-- Super Admin -->
                        <?php elseif ($current_user['AccountType']['name'] == 'Super Admin'): ?>
                            <?php if ($account['Account']['root_user'] == 0): ?>
                            <?php echo $this->Html->link('<i class="btn-icon-only icon-edit"></i>',
                                    array('controller' => 'accounts', 'action' => 'edit', $account['Account']['id']),
                                    array('class' => 'btn btn-small btn-success', 'escape' => false,
                                        'data-toggle' => 'tooltip', 'title' => 'Edit'));?>
                        ...
                        <!-- Facility Manager -->
                        <?php elseif ($current_user['AccountType']['name'] == 'Facility Manager'): ?>
                        <?php echo $this->Html->link('<i class="btn-icon-only icon-edit"></i>',
                                array('controller' => 'accounts', 'action' => 'edit', $account['Account']['id']),
                                array('class' => 'btn btn-small btn-success', 'escape' => false,
                                    'data-toggle' => 'tooltip', 'title' => 'Edit'));?>
