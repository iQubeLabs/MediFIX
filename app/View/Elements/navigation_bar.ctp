<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container"> 
        ...
        </a><a class="brand" href="/medifix" style="padding: 0px 20px 5px;"> <?php echo $this->Html->image('medifix_dashboard.png'); ?> </a>
...
<!--          <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-cog"></i> Account <b class="caret"></b></a>
        ...
        <div class="navbar-search pull-right">
          <a id='search_field_btn' class="btn"><i class="shortcut-icon icon-search"> Search</i></a>
        </div>
      </div>
      <!--/.nav-collapse --> 
    </div>
